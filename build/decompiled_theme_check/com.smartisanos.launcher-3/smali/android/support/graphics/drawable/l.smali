.class public Landroid/support/graphics/drawable/l;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    invoke-direct {p0, v0, p1, p2, p3}, Landroid/support/graphics/drawable/l;-><init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;Lorg/xmlpull/v1/XmlPullParser;)V
...
.method public constructor <init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;Landroid/util/AttributeSet;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 3
    sget-object v0, Landroid/support/graphics/drawable/a;->ic:[I
    ...
    .line 4
    invoke-direct {p0, p1, p4}, Landroid/support/graphics/drawable/l;->b(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
...
.method private a(Landroid/graphics/Path;)V
    ...
    iput-object v4, p0, Landroid/support/graphics/drawable/l;->mX:[F

    .line 5
    new-array v4, v2, [F

    iput-object v4, p0, Landroid/support/graphics/drawable/l;->mY:[F
    ...
    .line 7
    iget-object v6, p0, Landroid/support/graphics/drawable/l;->mX:[F
    ...
    .line 8
    iget-object v6, p0, Landroid/support/graphics/drawable/l;->mY:[F
    ...
    .line 9
    :cond_0
    iget-object p1, p0, Landroid/support/graphics/drawable/l;->mX:[F
    ...
    iget-object p1, p0, Landroid/support/graphics/drawable/l;->mY:[F
    ...
    .line 11
    iget-object v4, p0, Landroid/support/graphics/drawable/l;->mX:[F
    ...
    iget-object v5, p0, Landroid/support/graphics/drawable/l;->mY:[F
    ...
    iget-object v1, p0, Landroid/support/graphics/drawable/l;->mX:[F
    ...
    iget-object p0, p0, Landroid/support/graphics/drawable/l;->mY:[F
...
.method private b(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 4
    invoke-direct {p0, p2}, Landroid/support/graphics/drawable/l;->a(Landroid/graphics/Path;)V
    ...
    .line 12
    invoke-direct {p0, v0, v1}, Landroid/support/graphics/drawable/l;->y(FF)V
    ...
    .line 15
    invoke-direct {p0, v0, v1, v2, p1}, Landroid/support/graphics/drawable/l;->j(FFFF)V
...
.method private j(FFFF)V
    ...
    .line 4
    invoke-direct {p0, v7}, Landroid/support/graphics/drawable/l;->a(Landroid/graphics/Path;)V
...
.method private y(FF)V
    ...
    .line 4
    invoke-direct {p0, v0}, Landroid/support/graphics/drawable/l;->a(Landroid/graphics/Path;)V
...
.method public getInterpolation(F)F
    ...
    .line 1
    iget-object v2, p0, Landroid/support/graphics/drawable/l;->mX:[F
    ...
    .line 3
    iget-object v5, p0, Landroid/support/graphics/drawable/l;->mX:[F
    ...
    .line 4
    :cond_3
    iget-object v3, p0, Landroid/support/graphics/drawable/l;->mX:[F
