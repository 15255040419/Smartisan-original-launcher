...
.field private ra:Landroid/arch/core/b/a;
...
.method public constructor <init>(Landroid/arch/lifecycle/l;)V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/o;->ra:Landroid/arch/core/b/a;

    const/4 v0, 0x0

    .line 3
    iput v0, p0, Landroid/arch/lifecycle/o;->ta:I

    .line 4
    iput-boolean v0, p0, Landroid/arch/lifecycle/o;->ua:Z

    .line 5
    iput-boolean v0, p0, Landroid/arch/lifecycle/o;->va:Z
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/o;->wa:Ljava/util/ArrayList;
    ...
    .line 8
    sget-object p1, Landroid/arch/lifecycle/Lifecycle$State;->BM:Landroid/arch/lifecycle/Lifecycle$State;
...
.method static a(Landroid/arch/lifecycle/Lifecycle$Event;)Landroid/arch/lifecycle/Lifecycle$State;
    ...
    .line 17
    sget-object v0, Landroid/arch/lifecycle/m;->qa:[I
...
.method private static c(Landroid/arch/lifecycle/Lifecycle$State;)Landroid/arch/lifecycle/Lifecycle$Event;
    ...
    .line 5
    sget-object v0, Landroid/arch/lifecycle/m;->xa:[I
...
.method private c(Landroid/arch/lifecycle/k;)Landroid/arch/lifecycle/Lifecycle$State;
    ...
    .line 1
    iget-object v0, p0, Landroid/arch/lifecycle/o;->ra:Landroid/arch/core/b/a;
    ...
    .line 3
    :goto_0
    iget-object v1, p0, Landroid/arch/lifecycle/o;->wa:Ljava/util/ArrayList;
    ...
    iget-object v0, p0, Landroid/arch/lifecycle/o;->wa:Ljava/util/ArrayList;
...
.method private d(Landroid/arch/lifecycle/Lifecycle$State;)V
    ...
    .line 3
    iget-boolean p1, p0, Landroid/arch/lifecycle/o;->ua:Z

    const/4 v0, 0x1

    if-nez p1, :cond_2

    iget p1, p0, Landroid/arch/lifecycle/o;->ta:I
    ...
    .line 6
    iput-boolean p1, p0, Landroid/arch/lifecycle/o;->ua:Z
...
.method private e(Landroid/arch/lifecycle/Lifecycle$State;)V
    ...
    .line 1
    iget-object p0, p0, Landroid/arch/lifecycle/o;->wa:Ljava/util/ArrayList;
...
.method private h(Landroid/arch/lifecycle/l;)V
    ...
    iget-boolean v1, p0, Landroid/arch/lifecycle/o;->va:Z
    ...
    iget-boolean v3, p0, Landroid/arch/lifecycle/o;->va:Z

    if-nez v3, :cond_0

    iget-object v3, p0, Landroid/arch/lifecycle/o;->ra:Landroid/arch/core/b/a;
    ...
    .line 11
    invoke-direct {p0}, Landroid/arch/lifecycle/o;->uk()V
...
.method private i(Landroid/arch/lifecycle/l;)V
    ...
    .line 2
    invoke-virtual {v0}, Landroid/arch/core/b/i;->k()Landroid/arch/core/b/f;
...
.method private sync()V
    ...
    :cond_0
    :goto_0
    invoke-direct {p0}, Landroid/arch/lifecycle/o;->tk()Z
    ...
    .line 4
    iput-boolean v2, p0, Landroid/arch/lifecycle/o;->va:Z

    .line 5
    iget-object v1, p0, Landroid/arch/lifecycle/o;->mState:Landroid/arch/lifecycle/Lifecycle$State;

    iget-object v2, p0, Landroid/arch/lifecycle/o;->ra:Landroid/arch/core/b/a;
    ...
    .line 7
    :cond_1
    iget-object v1, p0, Landroid/arch/lifecycle/o;->ra:Landroid/arch/core/b/a;

    invoke-virtual {v1}, Landroid/arch/core/b/i;->l()Ljava/util/Map$Entry;

    move-result-object v1

    .line 8
    iget-boolean v2, p0, Landroid/arch/lifecycle/o;->va:Z
...
.method private tk()Z
    ...
    invoke-virtual {v2}, Landroid/arch/core/b/i;->l()Ljava/util/Map$Entry;
...
.method public a(Landroid/arch/lifecycle/k;)V
    ...
    :cond_0
    sget-object v1, Landroid/arch/lifecycle/Lifecycle$State;->BM:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    .line 6
    :cond_2
    iget v2, p0, Landroid/arch/lifecycle/o;->ta:I

    const/4 v3, 0x1

    if-nez v2, :cond_4

    iget-boolean v2, p0, Landroid/arch/lifecycle/o;->ua:Z
    ...
    .line 8
    iget v5, p0, Landroid/arch/lifecycle/o;->ta:I

    add-int/2addr v5, v3

    iput v5, p0, Landroid/arch/lifecycle/o;->ta:I
    ...
    iget-object v4, p0, Landroid/arch/lifecycle/o;->ra:Landroid/arch/core/b/a;
    ...
    iput p1, p0, Landroid/arch/lifecycle/o;->ta:I
...
.method public b(Landroid/arch/lifecycle/k;)V
    ...
    .line 3
    iget-object p0, p0, Landroid/arch/lifecycle/o;->ra:Landroid/arch/core/b/a;
