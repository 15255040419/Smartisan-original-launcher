...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v1}, Landroid/icu/text/MessagePatternUtil$MessageContentsNode$Type;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v0, v3, v2}, Landroid/icu/text/MessagePatternUtil$MessageContentsNode$Type;-><init>(Ljava/lang/String;I)V
    ...
    const-string v4, "REPLACE_NUMBER"

    invoke-direct {v0, v4, v3}, Landroid/icu/text/MessagePatternUtil$MessageContentsNode$Type;-><init>(Ljava/lang/String;I)V
    ...
    .line 124
    sget-object v4, Landroid/icu/text/MessagePatternUtil$MessageContentsNode$Type;->TEXT:Landroid/icu/text/MessagePatternUtil$MessageContentsNode$Type;
...
.method public static valueOf(Ljava/lang/String;)Landroid/icu/text/MessagePatternUtil$MessageContentsNode$Type;
    ...
    check-cast p0, Landroid/icu/text/MessagePatternUtil$MessageContentsNode$Type;
...
.method public static values()[Landroid/icu/text/MessagePatternUtil$MessageContentsNode$Type;
    ...
    invoke-virtual {v0}, [Landroid/icu/text/MessagePatternUtil$MessageContentsNode$Type;->clone()Ljava/lang/Object;
