...
.method private static assertMainThread(Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Landroid/arch/core/a/c;->m()Z
...
.method private considerNotify(Landroid/arch/lifecycle/u;)V
    ...
    .line 2
    :cond_0
    invoke-virtual {p1}, Landroid/arch/lifecycle/u;->q()Z
    ...
    .line 4
    :cond_1
    iget v0, p1, Landroid/arch/lifecycle/u;->ka:I
    ...
    .line 5
    :cond_2
    iput v1, p1, Landroid/arch/lifecycle/u;->ka:I
...
.method private dispatchingValue(Landroid/arch/lifecycle/u;)V
    ...
    .line 7
    invoke-virtual {v1}, Landroid/arch/core/b/i;->n()Landroid/arch/core/b/f;
...
.method public removeObserver(Landroid/arch/lifecycle/y;)V
    ...
    .line 3
    :cond_0
    invoke-virtual {p0}, Landroid/arch/lifecycle/u;->p()V
