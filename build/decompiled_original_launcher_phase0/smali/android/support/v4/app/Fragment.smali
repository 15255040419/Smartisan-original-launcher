...
.field mLifecycleRegistry:Landroid/arch/lifecycle/o;
...
.field mViewLifecycleOwner:Landroid/arch/lifecycle/l;

.field mViewLifecycleOwnerLiveData:Landroid/arch/lifecycle/x;

.field private mViewLifecycleRegistry:Landroid/arch/lifecycle/o;

.field mViewModelStore:Landroid/arch/lifecycle/G;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v4/app/Fragment;->mLifecycleRegistry:Landroid/arch/lifecycle/o;
    ...
    iput-object v0, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleOwnerLiveData:Landroid/arch/lifecycle/x;
...
.method static synthetic access$900(Landroid/support/v4/app/Fragment;)Landroid/arch/lifecycle/o;
    .locals 0

    .line 1
    iget-object p0, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleRegistry:Landroid/arch/lifecycle/o;

    return-object p0
.end method

.method static synthetic access$902(Landroid/support/v4/app/Fragment;Landroid/arch/lifecycle/o;)Landroid/arch/lifecycle/o;
    .locals 0

    .line 1
    iput-object p1, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleRegistry:Landroid/arch/lifecycle/o;
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    .line 57
    :cond_b
    invoke-static {p0}, Landroid/support/v4/app/LoaderManager;->getInstance(Landroid/arch/lifecycle/l;)Landroid/support/v4/app/LoaderManager;
...
.method public getLifecycle()Landroid/arch/lifecycle/j;
    ...
    .line 1
    iget-object p0, p0, Landroid/support/v4/app/Fragment;->mLifecycleRegistry:Landroid/arch/lifecycle/o;
...
.method public getViewLifecycleOwner()Landroid/arch/lifecycle/l;
    .locals 1

    .line 1
    iget-object p0, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleOwner:Landroid/arch/lifecycle/l;
...
.method public getViewLifecycleOwnerLiveData()Landroid/arch/lifecycle/v;
    .locals 0

    .line 1
    iget-object p0, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleOwnerLiveData:Landroid/arch/lifecycle/x;

    return-object p0
.end method

.method public getViewModelStore()Landroid/arch/lifecycle/G;
    .locals 1
    ...
    .line 2
    iget-object v0, p0, Landroid/support/v4/app/Fragment;->mViewModelStore:Landroid/arch/lifecycle/G;
    ...
    invoke-direct {v0}, Landroid/arch/lifecycle/G;-><init>()V

    iput-object v0, p0, Landroid/support/v4/app/Fragment;->mViewModelStore:Landroid/arch/lifecycle/G;

    .line 4
    :cond_0
    iget-object p0, p0, Landroid/support/v4/app/Fragment;->mViewModelStore:Landroid/arch/lifecycle/G;
...
.method public onDestroy()V
    ...
    .line 3
    invoke-virtual {v0}, Landroid/arch/lifecycle/G;->clear()V
...
.method public onDestroyView()V
    ...
    invoke-virtual {p0, v0}, Landroid/arch/lifecycle/o;->b(Landroid/arch/lifecycle/Lifecycle$Event;)V
...
.method public onViewStateRestored(Landroid/os/Bundle;)V
    ...
    invoke-virtual {p0, p1}, Landroid/arch/lifecycle/o;->b(Landroid/arch/lifecycle/Lifecycle$Event;)V
...
.method performCreateView(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/os/Bundle;)V
    ...
    iput-object v0, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleOwner:Landroid/arch/lifecycle/l;

    const/4 v0, 0x0

    .line 5
    iput-object v0, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleRegistry:Landroid/arch/lifecycle/o;
    ...
    .line 8
    iget-object p1, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleOwner:Landroid/arch/lifecycle/l;

    invoke-interface {p1}, Landroid/arch/lifecycle/l;->getLifecycle()Landroid/arch/lifecycle/j;

    .line 9
    iget-object p1, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleOwnerLiveData:Landroid/arch/lifecycle/x;

    iget-object p0, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleOwner:Landroid/arch/lifecycle/l;

    invoke-virtual {p1, p0}, Landroid/arch/lifecycle/x;->setValue(Ljava/lang/Object;)V

    goto :goto_0

    .line 10
    :cond_1
    iget-object p1, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleRegistry:Landroid/arch/lifecycle/o;
...
.method performDestroy()V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/app/Fragment;->mLifecycleRegistry:Landroid/arch/lifecycle/o;

    sget-object v1, Landroid/arch/lifecycle/Lifecycle$Event;->ON_DESTROY:Landroid/arch/lifecycle/Lifecycle$Event;

    invoke-virtual {v0, v1}, Landroid/arch/lifecycle/o;->b(Landroid/arch/lifecycle/Lifecycle$Event;)V
...
.method performPause()V
    ...
    .line 2
    iget-object v0, p0, Landroid/support/v4/app/Fragment;->mViewLifecycleRegistry:Landroid/arch/lifecycle/o;
