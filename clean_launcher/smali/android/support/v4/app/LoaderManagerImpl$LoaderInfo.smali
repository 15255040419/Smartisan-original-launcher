...
.field private mLifecycleOwner:Landroid/arch/lifecycle/l;
...
.method destroy(Z)Landroid/support/v4/content/Loader;
    ...
    .line 5
    invoke-virtual {p0, v0}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->removeObserver(Landroid/arch/lifecycle/y;)V
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    invoke-virtual {p0}, Landroid/arch/lifecycle/v;->getValue()Ljava/lang/Object;
    ...
    .line 12
    invoke-virtual {p0}, Landroid/arch/lifecycle/v;->hasActiveObservers()Z
...
.method markForRedelivery()V
    ...
    .line 1
    iget-object v0, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLifecycleOwner:Landroid/arch/lifecycle/l;
    ...
    .line 3
    invoke-super {p0, v1}, Landroid/arch/lifecycle/v;->removeObserver(Landroid/arch/lifecycle/y;)V

    .line 4
    invoke-virtual {p0, v0, v1}, Landroid/arch/lifecycle/v;->observe(Landroid/arch/lifecycle/l;Landroid/arch/lifecycle/y;)V
...
.method public onLoadComplete(Landroid/support/v4/content/Loader;Ljava/lang/Object;)V
    ...
    .line 6
    :cond_2
    invoke-virtual {p0, p2}, Landroid/arch/lifecycle/x;->postValue(Ljava/lang/Object;)V
...
.method public removeObserver(Landroid/arch/lifecycle/y;)V
    ...
    .line 1
    invoke-super {p0, p1}, Landroid/arch/lifecycle/v;->removeObserver(Landroid/arch/lifecycle/y;)V

    const/4 p1, 0x0

    .line 2
    iput-object p1, p0, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->mLifecycleOwner:Landroid/arch/lifecycle/l;
...
.method setCallback(Landroid/arch/lifecycle/l;Landroid/support/v4/app/LoaderManager$LoaderCallbacks;)Landroid/support/v4/content/Loader;
    .locals 2
    ...
    .line 2
    invoke-virtual {p0, p1, v0}, Landroid/arch/lifecycle/v;->observe(Landroid/arch/lifecycle/l;Landroid/arch/lifecycle/y;)V
    ...
    .line 4
    invoke-virtual {p0, p2}, Landroid/support/v4/app/LoaderManagerImpl$LoaderInfo;->removeObserver(Landroid/arch/lifecycle/y;)V
...
.method public setValue(Ljava/lang/Object;)V
    ...
    .line 1
    invoke-super {p0, p1}, Landroid/arch/lifecycle/x;->setValue(Ljava/lang/Object;)V
